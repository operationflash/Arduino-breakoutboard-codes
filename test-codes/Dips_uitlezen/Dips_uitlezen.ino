...
byte buttonState2 = 0;         // variabele voor het uitlezen van dip 2
byte buttonState3 = 0;         // variabele voor het uitlezen van dip 3
byte buttonState4 = 0;         // variabele voor het uitlezen van dip 4
